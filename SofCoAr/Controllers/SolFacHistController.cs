...
namespace SofCoAr.Controllers
{
    ...
    public class SolFacHistController : ApiController
    {
        ...
        private ISolFacHistRepo _repo;

        public SolFacHistController(ISolFacHistRepo repo)
        {
            _repo = repo;
        }
        ...
        [HttpPost]
        public IHttpActionResult Add([FromBody] SolFacHist item)
        {
            if (item == null)
            {
                return BadRequest();
        ...
        [HttpPut]
        public IHttpActionResult Update([FromBody] SolFacHist item)
        {
            if (item == null)
            {
                return BadRequest();
